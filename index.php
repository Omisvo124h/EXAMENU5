        ...
        <section class="resultado">
            ...
            <div id="resultadoA">
                <?php
                    ...
                    // Tiempo en días para amortizar
                    $tiempo_amortizacion_dias = ($precio_colector * $dias_anuales) / $costo_anual;

                    // Convertir el tiempo de amortización a años
                    $tiempo_amortizacion_anios = $tiempo_amortizacion_dias / 365;

                    // Mostrar resultados
                    echo "<p><strong>Tiempo de amortización:</strong> " . round($tiempo_amortizacion_anios, 2) . " años</p>";
